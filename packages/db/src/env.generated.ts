...
type _CoercedEnvSchema_4522ac0c = CoercedEnvSchema;
...
type _EnvSchemaAsStrings_4522ac0c = EnvSchemaAsStrings;

export type PublicCoercedEnvSchema = Readonly<Pick<CoercedEnvSchema, 'RUN_PRODUCTION_MIGRATIONS'>>;
