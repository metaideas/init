...
export type CoercedEnvSchema = {
  ...
  /**
   * **PUBLIC_SITE_URL**  
   * Optional canonical marketing site URL.  
...
type _CoercedEnvSchema_b2edaf8e = CoercedEnvSchema;
...
type _EnvSchemaAsStrings_b2edaf8e = EnvSchemaAsStrings;

export type PublicCoercedEnvSchema = Readonly<Pick<CoercedEnvSchema, 'PUBLIC_SITE_URL' | 'PORT'>>;
